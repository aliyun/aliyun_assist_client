...
// usage:
//
// go run genznmap.go -output zoneinfo_nmap_windows.go
//
...
var filename = flag.String("output", "zoneinfo_nmap_windows.go", "output file name")
...
{{range .Zs}}	"{{.WinName}}": "{{.UnixName}}", // {{.StTime}}, {{.DSTime}}
{{end}}}
