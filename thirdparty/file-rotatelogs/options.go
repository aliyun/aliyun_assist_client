...
import (
	...
	"github.com/aliyun/aliyun_assist_client/thirdparty/file-rotatelogs/internal/option"
)
...
const (
	...
	optkeyIgnoreRotationError = "ignore-rotation-error"
)
...
// IgnoreRotationError ignores error encountered during performing rotation
func IgnoreRotationError(v bool) Option {
	return option.New(optkeyIgnoreRotationError, v)
}
