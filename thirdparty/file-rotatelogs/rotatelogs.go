...
func New(p string, options ...Option) (*RotateLogs, error) {
	...
	for _, o := range options {
		...
		case optkeyIgnoreRotationError:
			ignoreRotationError = o.Value().(bool)
		}
	}
	...
	return &RotateLogs{
		...
		ignoreRotationError: ignoreRotationError,
	}, nil
}
